...
const UserPage = () => {
  ...
  const handleTypeClick = (type) => {
    ...
    navigate('/userpage/form', { state: { category: selectedCategory, type }, key: `${selectedCategory}-${type}` });
  };
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <div className="w-64 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white p-6 space-y-6 shadow-lg">
        <h2 className="text-2xl font-bold tracking-wide mb-4 text-center">User Dashboard</h2>
        <ul className="space-y-4">
          ...
          <li>
            ...
            >
              {showCategorySelector ? 'Close' : 'Select Items'}
            </button>
          </li>
        </ul>
      ...
      <div className="flex-1 p-8">
        ...
        {/* Render Form or Content based on selection */}
